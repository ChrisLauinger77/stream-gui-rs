...
pub fn typescript_bindings() -> String {
    ...
    let declarations = [
        ...
        TeamRequest::decl(&config),
        TeamDetails::decl(&config),
        ...
        ThemePalette::decl(&config),
        SchemeColours::decl(&config),
        CustomTheme::decl(&config),
        crate::config::discovery::ItemKind::decl(&config),
        crate::config::discovery::SavedItem::decl(&config),
        crate::config::discovery::DiscoveryPreferences::decl(&config),
        crate::config::discovery::DiscoveryList::decl(&config),
        crate::config::discovery::DiscoveryMutation::decl(&config),
        shortcuts::ShortcutAction::decl(&config),
        shortcuts::ShortcutBinding::decl(&config),
        shortcuts::ShortcutBindings::decl(&config),
        ChatProvider::decl(&config),
        profiles::PlayerProfile::decl(&config),
        profiles::ProfileDraft::decl(&config),
        profiles::ProfileMutation::decl(&config),
        crate::updates::UpdatePhase::decl(&config),
        crate::updates::UpdateStatus::decl(&config),
