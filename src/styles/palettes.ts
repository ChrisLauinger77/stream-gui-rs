// Adapted from Sidra's bundled palettes (Blue Oak Model License 1.0.0).
// License text: https://blueoakcouncil.org/license/1.0.0
//
// Bundled theme palettes. Each palette maps an upstream colour scheme
// onto the 12 semantic slots consumed by this application's adapter. Shades
// marked "derived" have no upstream equivalent and are interpolated to
// fit the slot's role.
//
// Two rules, checked by this application's palette tests:
...
// - The app adapter checks foreground contrast on its own backgrounds.
//   Catppuccin Latte's shipped secondary colour needs adjustment here.
//
...
import type { SchemeColours } from "../lib/generated";
...
/** Names of the bundled themes, matching the Rust settings enum. */
...
/** Every bundled theme, in Settings order. */
